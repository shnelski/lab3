    ...
    <tbody>   
        ...
        $request_array=read();
                ...
                foreach ($request_array as $key){  ?>
                    ...
                    <td><a href="#" data-role="update" data-id="<?php echo $key[0];?>"class="btn btn-warning btn btn-primary ">Update</a></td>
                    <td><button type="button" onclick="myAjax(<?php echo $key[0];?>)"class="btn btn-danger btn btn-primary ">Delete</button></td>
                </tr>
...
function myAjax(t) {
    ...
    <div style="padding:10px 20px; margin-left: 100px;">
        ...
        <button type="button" onclick="myAjax2()" class="btn btn-success btn btn-primary ">ADD NEW</button>
    </div>
